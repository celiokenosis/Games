...
public class Player extends Entity{
	...
	public int ammo = 0;
	public int mx,my; /*posições do mouse*/
	...
	public Player(int x, int y, int width, int height, BufferedImage bufferedImage) {
		...
		PlayerDamage = Game.spritesheet.getSprite(36, 32, 16, 16);
	...
	//LifePack
	public void checkColissionsLifePack() {
	...
	//Arma
	public void checkColissionsGun() {
		for(int i = 0; i < Game.entities.size(); i++) {
			Entity atual = Game.entities.get(i);
	...
	//Munição
	public void checkColissionsAmmo() {
		for(int i = 0; i < Game.entities.size(); i++) {
			Entity atual = Game.entities.get(i);
