...
public class World {
	...
	public static void restartGame(){
		Game.player = new Player(0,0,16,16,2,Game.spritesheet.getSprite(48, 0,16,16));
		Game.entities.clear();
